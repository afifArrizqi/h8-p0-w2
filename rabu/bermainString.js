...
console.log("1. Let's Form a Sentence".toUpperCase());
...
console.log('2. Index Accessing - 1 by 1'.toUpperCase());
...
console.log('3. Breaking Sentence (Again) using Substring'.toUpperCase());
...
console.log('4. Breaking Sentence (yet Again) and Count Each Length'.toUpperCase());
